...
Vagrant.configure("2") do |config|
  ...
  # add port forwarding for node server

  # ran into lots of problems with port collisions at lower ports like 8099 so bumping up to the top limit
  config.vm.network "forwarded_port", guest: 65001, host: 65001
